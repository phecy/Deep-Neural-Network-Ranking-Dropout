...
export CUDA_SDK_PATH=/usr/local/NVIDIA_GPU_Computing_SDK

# Python include directory. This should contain the file Python.h, among others.
export PYTHON_INCLUDE_PATH=/home/vis/common/include/python2.7/

# Numpy include directory. This should contain the file arrayobject.h, among others.
export NUMPY_INCLUDE_PATH=/home/vis/common/lib/python2.7/site-packages/numpy/core/include/numpy/
